    ...
    return (
        <div>
            <div className="herobox  flex justify-center items-center md:flex-row flex-col   ">
                <div className="content ml-4 w-1/2 ">
                    <div className=" justify-center items-center">
                        <div >
                            <div className="spannn "><span className='text-xl font-bold mb-0 '>Plan Your Trip Now</span>
</div>  
                        <h1 className="  font-heading text-4xl  md:text-6xl  font-bold text-gray-900 mb-8 sm:mb-14">
                        ...
                        <Link className="relative px-4 group shadow-lg inline-block w-full sm:w-auto py-4  mb-24 text-white font-semibold rounded-md bg-red-500 overflow-hidden" href="#">
                            ...
                            <div className="relative flex items-center justify-center">
                                ...
                                <span>
                                    <svg width="8" height="12" className="0 0 8 12" fill="none" xmlns="http://www.w3.org/2000/svg">
