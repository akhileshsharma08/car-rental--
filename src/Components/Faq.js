                        ...
                        <div className="container mx-auto">
                            <div className="container">
                                ...
                                <Accordion.Item eventKey="0">
                                    <Accordion.Header className="text-light bg-danger">1.What is special about comparing rental car deals?</Accordion.Header>
                                    <Accordion.Body>
                                ...
                                <Accordion.Item eventKey="1">
                                    <Accordion.Header className="text-light bg-danger">2. How do I find the car rental deals?</Accordion.Header>
                                    <Accordion.Body>
                                ...
                                <Accordion.Item eventKey="2">
                                    <Accordion.Header className="text-light bg-danger">3. How do I find such low rental car prices?</Accordion.Header>
