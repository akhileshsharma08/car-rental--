...
const Feature = () => {
    return (
        <div className='featurebox mt-10 py-20'>
            ...
            <div className="featureimgbox flex flex-col md:flex-row justify-center items-center my-5 pt-8">
                <div className="w-1/3 my-4 mx-4">
                ...
                <div className="w-1/3 my-4 mx-4">
                    ...
                    <p className='text-center text-gray-700 mx-4'>Whether you're hitting the open road, we've got you covered with our wide range of cars</p>
                </div>
            </div>
        </div>
    )
