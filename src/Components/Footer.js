...
const Footer = () => {
  return (
    <div>
   <footer class="text-gray-600 body-font border-t border-gray-200 bg-gray-200">
  <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
      <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
        <img src="../Logo.png" alt="car rental logo" width={200} height={100}/>
        {/* <span class="ml-3 text-xl font-bold ">CAR <span className='text-red-500'>RENTAL</span> </span> */}
      </a>
      <p class="mt-2 text-lg text-gray-500 mx-2">Quick,Easy Car Rentals</p>
    </div>
